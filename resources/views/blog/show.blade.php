    ...
    <div class="container pt-36">
        ...
        <div class="w-full self-center px-4">
            <div class="w-full self-end px-4">
                <div class="relative mt-10 lg:mt-9  lg:right-0">
                    <img src="/storage/{{ $blog->image }}" alt="{{ $blog->title }}" class="max-w-full mx-auto relative z-10 text-white"/>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 flex flex-wrap">
            <div class="w-full self-center px-6 lg:w-3/4">
                ...
                <p class="font-medium text-secondary mb-10 leading-relaxed">Dibuat oleh <a href="">{{ $user->name }}</a> pada {{ date ('d/m/Y', strtotime ($blog->created_at)) }}</p>

                {{-- comment section --}}
                <x-comment :type="1" :slug="$blog->slug" :comments="$comments"></x-comment>
            </div>
