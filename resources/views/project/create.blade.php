                ...
                <div class="container">
                    <div class="w-full px-4">
                        <div class="mx-auto text-center mb-16">
                            <h4 class="font-semibold text-lg text-primary mb-2">Porject</h4>
                            <h2 class="font-bold text-dark dark:text-white text-3xl mb-4 sm:text-4xl lg:text-5xl">Tambahkan Project Baru</h2>
                            <p class="font-medium text-md text-secondary md:text-lg">Bagikan pengalamanmu!</p>
                        </div>
                    </div>
                    ...
                    <form action="/project" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="w-full lg:w-2/3 lg:mx-auto">
                            ...
                            <div class="w-full mb-8 px-4">
                                ...
                                <textarea type="text" id="projectEditor" name="content" class="w-full bg-white text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary">
                                    {{ old('content') }}
                                </textarea>
                            </div>
                            <div class="w-full">
