    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                <h2 class="font-bold text-4xl text-white mb-5">alif naufal</h2>
            ...
            <div class="w-full px-4 mb12 md:w-1/3">
                ...
                <ul class="text-slate-300">
                    ...
                    <li>
                        <a href="" class="inline-block text-base hover:text-primary mb-3">Tentang Saya</a>
                    </li>
                    <li>
        ...
        <div class="w-full pt-10 border-t border-slate-800">
            ...
            <p class="font-medium text-sm text-slate-500 text-center">Dibuat dengan <span class="text-pink-500">❤</span> oleh <a href="https://instagram.com/alifnrz27" target="_blank" class="font-bold text-primary">Alif Naufal Rizki</a></p>
        </div>
    </div>
</footer>npx tailwindcss -i ./public/assets/css/input.css -o ./public/assets/css/output.css --watch